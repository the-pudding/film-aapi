...
declare module '$env/static/private' {
	...
	export const JUPYTER_MEMORY_LIMIT: string;
	...
	export const JUPYTER_ALLOW_INSECURE_WRITES: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		JUPYTER_ALLOW_INSECURE_WRITES: string;
